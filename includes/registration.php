...
<div class="modal fade" id="signupform" style="overflow: auto">
                    ...
                    <div class="signup_wrap">
                        <div class="col-md-12 col-sm-12">
                            <form method="post" name="signup" onSubmit="return valid();">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="citizenshipno"
                                           placeholder="Citizenship ID Number" maxlength="15" required="required">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="licenseno"
                                           placeholder="Driving License Number" maxlength="15" required="required">
                                </div>
                                <div class="form-group">
